...
/*   Updated: 2020/07/29 20:34:19 by amayor           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_utils_print_int(char *substr, int tmp, t_flags flags,
																size_t len);
...
int					ft_parser_hex(unsigned int number, int flag,
														t_flags s_flags);
int					ft_parser_unsigned(unsigned int num, t_flags flags);
char				*ft_str_tolower(char *str);
int					ft_utils_print_addr(char *addr, t_flags s_flags,
													size_t len);
